...
export const api = {
  ...
  notes: {
    ...
    folderCreate: (name: string, parent_id?: string, color?: string) => call<NoteFolder>('note_folder_create', { name, parent_id, color }),
    ...
    noteSetFolder: (note_id: string, folder_id: string | null) => call<void>('note_set_folder', { note_id, folder_id }),
